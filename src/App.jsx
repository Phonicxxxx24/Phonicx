...
const Web3_work = [
  ...
  },
  {
    ...
    link: null,
    hasDetails: true,
    image: "https://res.cloudinary.com/duf6r8fhk/image/upload/v1765207933/meme_upload_qenv7u.png", 
    details: {
  ...
  },
  {
    ...
    description: "Interactive prototypes demonstrating Web3's high-speed architecture, low-cost execution, and privacy-first design.",
    tags: ["Privacy", "Speed", "Low Cost"],
    type: "game",
    ...
    image: "", 
    details: {
      about: "A playground for demonstrating Web3's technical capabilities. These interactive simulations visualize how the network handles high throughput, ensures privacy, and maintains minimal transaction costs.",
      features: null, 
      simulations: [
        {
          id: 1,
          title: "Native Privacy Simulator",
          description: "Public Blockchain Expose Secrets Rialo REX Keeps Them Confidential",
          link: "https://privacy-simulator-rialo.vercel.app/", // Add link here to activate
          image: "https://res.cloudinary.com/duf6r8fhk/image/upload/v1768581997/Screenshot_2026-01-16_221508_ejoo9f.png" // Add image here
        },
        {
          id: 2,
          title: "Coming Soon",
...
const ACHIEVEMENTS = [
  {
    ...
    demoLink: "https://raiku-visualizer-seven.vercel.app/", 
    details: {
  ...
  },
  {
    ...
    demoLink: "https://oorja-mitra.vly.site/dashboard", 
    details: {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 py-12">
        ...
        {/* Content Section: Gallery, Simulations List, or Standard Layout */}
        
        {project.details?.gallery ? (
          // --- GALLERY LAYOUT (Creative Content, Deep Research) ---
          <motion.div 
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {project.details.gallery.map((item, idx) => {
                ...
                else if (item.link === "#") linkLabel = "COMING SOON";
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className={`group relative aspect-[4/3] rounded-xl bg-white/5 border border-white/10 overflow-hidden ${item.link !== "#" ? "hover:border-[#a9ddd3] hover:shadow-[0_0_20px_rgba(169,221,211,0.2)]" : ""} transition-all duration-300`}
                >
                  {item.image ? (
                     <img 
                       src={item.image} 
        ...
        ) : project.details?.simulations ? (
          // --- SIMULATIONS LIST LAYOUT ---
          <motion.div 
             initial={{ opacity: 0, y: 30 }}
             animate={{ opacity: 1, y: 0 }}
             transition={{ delay: 0.3 }}
          ...
          >
            {project.details.about && (
              <p className="text-gray-400 text-lg max-w-4xl leading-relaxed mb-12">
                {project.details.about}
              </p>
            )}

            <div className="grid grid-cols-1 gap-8">
              {project.details.simulations.map((sim, idx) => (
                <div key={sim.id} className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md transition-all duration-300 hover:border-[#a9ddd3]/50">
                  <div className="flex flex-col md:flex-row h-full">
                    {/* Simulation Thumbnail */}
                    <div className="w-full md:w-1/3 min-h-[250px] relative bg-black/40 overflow-hidden border-b md:border-b-0 md:border-r border-white/10">
                      {sim.image ? (
                        <img 
                          src={sim.image} 
                          alt={sim.title} 
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                           <Gamepad2 className="text-[#a9ddd3] w-16 h-16 opacity-30" />
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex-1 p-8 flex flex-col justify-center">
                      <h3 className="text-2xl font-bold text-[#e8e3d5] mb-3">{sim.title}</h3>
                      <p className="text-gray-400 leading-relaxed mb-6">{sim.description}</p>
                      
                      <div className="mt-auto">
                        <a 
                          href={sim.link} 
                          target={sim.link === "#" ? "_self" : "_blank"}
                          rel="noopener noreferrer"
                          className={`inline-flex items-center gap-2 px-6 py-3 rounded-full text-sm font-bold tracking-wide transition-all ${sim.link !== "#" && sim.link !== "" ? "bg-[#a9ddd3] text-[#010101] hover:bg-white hover:translate-x-1" : "bg-white/10 text-gray-500 cursor-not-allowed"}`}
                        >
                          {sim.link !== "#" && sim.link !== "" ? "VIEW SIMULATION" : "COMING SOON"}
                          {sim.link !== "#" && sim.link !== "" && <ArrowRight size={16} />}
                        </a>
                      </div>
                    </div>
                  </div>
          ...
          // --- STANDARD LAYOUT (Raiku, Dashboard, Memes) ---
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-[#010101]/80 backdrop-blur-lg border-b border-white/5 py-4' : 'py-6'}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8 text-sm font-medium">
            <ScrollLink to="rialo" className="hover:text-[#a9ddd3] transition-colors">Web3 Work</ScrollLink>
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-400 mb-8 max-w-lg leading-relaxed">
              Building immersive web solutions, contributing to <span className="text-white font-semibold">Web3</span>, winning hackathons, and crafting the future of decentralized interfaces.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-400 leading-relaxed">
                ...
                <p>
                  Currently building for Web3, I spend my weekends at hackathons or exploring 
